...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mt-metadata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mt-metadata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mt-metadata
# for installing globally
pixi global install mt-metadata
```
...
It is possible to list all of the versions of `mt-metadata` available on your platform:
...
```
pixi search mt-metadata --channel conda-forge
```
