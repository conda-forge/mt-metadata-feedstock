...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mt-metadata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12355&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mt-metadata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mt-metadata` can be installed with:

```
conda install mt-metadata
```

It is possible to list all of the versions of `mt-metadata` available on your platform with:
